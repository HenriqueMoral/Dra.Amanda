...
def create_app():
    ...
    #app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://postgres:indio222@localhost/Draamanda"

    app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://postgres:indio222@localhost:5432/Draamanda"
